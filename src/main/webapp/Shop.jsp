...
<c:forEach items="${listP}" var="o">
  ...
  <script>
    ...
    function load(cateid){
    	 $.ajax({
             url: "/ServletProject/categoryShop",
    ...
    function searchByName(param){
        ...
        $.ajax({
            url: "/ServletProject/searchAjaxShop",
            type: "get", //send it through get method
            data: {
                txt: txtSearch
            },
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/ServletProject/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder100(){
        $.ajax({
            url: "/ServletProject/searchAjaxPriceUnder100Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice100To200(){
        $.ajax({
            url: "/ServletProject/searchAjaxPrice100To200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove200(){
        $.ajax({
            url: "/ServletProject/searchAjaxPriceAbove200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorWhite(){
        $.ajax({
            url: "/ServletProject/searchAjaxColorWhite",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorGray(){
        $.ajax({
            url: "/ServletProject/searchAjaxColorGray",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorBlack(){
        $.ajax({
            url: "/ServletProject/searchAjaxColorBlack",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorYellow(){
        $.ajax({
            url: "/ServletProject/searchAjaxColorYellow",
            type: "get", //send it through get method
            data: {
    ...
    function loadAmountCart(){
    	 $.ajax({
             url: "/ServletProject/loadAllAmountCart",
             type: "get", //send it through get method
             data: {
