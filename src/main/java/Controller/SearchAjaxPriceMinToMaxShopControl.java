...
import Models.*;
/**
 * Servlet implementation class SearchAjaxPriceMinToMaxShopControl
 */
...
public class SearchAjaxPriceMinToMaxShopControl extends HttpServlet {
     ...
     */
    public SearchAjaxPriceMinToMaxShopControl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //DAO dao = new DAO();
        var list = ServletRepository.getInstance().searchByPriceMinToMax(priceMin, priceMax);
